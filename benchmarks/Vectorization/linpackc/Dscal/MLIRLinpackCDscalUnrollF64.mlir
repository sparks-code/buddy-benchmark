...
func.func @mlir_linpackcdscalunrollf64(%n : i32, %da : f64, %dx: memref<?xf64>, %incx : i32) 
{
...
// 		return;
    ...
    {
      %dx_val_0 = memref.load %dx[%i_0] : memref<?xf64>
      %result_0 = arith.mulf %da, %dx_val_0 : f64
      memref.store %result_0, %dx[%i_0] : memref<?xf64>
    }
    return
...
// #endif
    ...
    ^continue3:
        scf.for %i_1 = %c0 to %m_index step %c1 {
            ...
            %result_1 = arith.mulf %dx_val_1, %da : f64
            memref.store %result_1, %dx[%i_1] : memref<?xf64>
        }
    ...
    ^continue4:
      ...
      %result_2 = arith.mulf %dx_val_2, %da : f64
      memref.store %result_2, %dx[%i_2] : memref<?xf64>

      %i_2_1 = arith.addi %i_2, %c1 : index
      %dx_val_3 = memref.load %dx[%i_2_1] : memref<?xf64>
      %result_3 = arith.mulf %dx_val_3, %da : f64
      memref.store %result_3, %dx[%i_2_1] : memref<?xf64>

      %i_2_2 = arith.addi %i_2, %c2 : index
      %dx_val_4 = memref.load %dx[%i_2_2] : memref<?xf64>
      %result_4 = arith.mulf %dx_val_4, %da : f64
      memref.store %result_4, %dx[%i_2_2] : memref<?xf64>

      %i_2_3 = arith.addi %i_2, %c3 : index
      %dx_val_5 = memref.load %dx[%i_2_3] : memref<?xf64>
      %result_5 = arith.mulf %dx_val_5, %da : f64
      memref.store %result_5, %dx[%i_2_3] : memref<?xf64>

      %i_2_4 = arith.addi %i_2, %c4 : index
      %dx_val_6 = memref.load %dx[%i_2_4] : memref<?xf64>
      %result_6 = arith.mulf %dx_val_6, %da : f64
      memref.store %result_6, %dx[%i_2_4] : memref<?xf64>
    }
    return
  ^terminator:
    return
