...
func.func @mlir_linpackcddotunrollf64(%n : i32, %dx: memref<?xf64>, %incx : i32, 
...
// 	return(dtemp);
    ...
    ^continue4:
      ...
      iter_args(%dtemp_iter_3 = %dtemp_0) -> (f64) {
      %dx_val_2 = memref.load %dx[%i_2] : memref<?xf64>
      %dy_val_2 = memref.load %dy[%i_2] : memref<?xf64>
      %result_2 = arith.mulf %dx_val_2, %dy_val_2 : f64

      %i_2_1 = arith.addi %i_2, %c1 : index
      %dx_val_3 = memref.load %dx[%i_2_1] : memref<?xf64>
      %dy_val_3 = memref.load %dy[%i_2_1] : memref<?xf64>
      %result_3 = arith.mulf %dx_val_3, %dy_val_3 : f64

      %i_2_2 = arith.addi %i_2, %c2 : index
      %dx_val_4 = memref.load %dx[%i_2_2] : memref<?xf64>
      %dy_val_4 = memref.load %dy[%i_2_2] : memref<?xf64>
      %result_4 = arith.mulf %dx_val_4, %dy_val_4 : f64

      %i_2_3 = arith.addi %i_2, %c3 : index
      %dx_val_5 = memref.load %dx[%i_2_3] : memref<?xf64>
      %dy_val_5 = memref.load %dy[%i_2_3] : memref<?xf64>
      %result_5 = arith.mulf %dx_val_5, %dy_val_5 : f64

      %i_2_4 = arith.addi %i_2, %c4 : index
      %dx_val_6 = memref.load %dx[%i_2_4] : memref<?xf64>
      %dy_val_6 = memref.load %dy[%i_2_4] : memref<?xf64>
      %result_6 = arith.mulf %dx_val_6, %dy_val_6 : f64

      %dtemp_temp_1 = arith.addf %dtemp_iter_3, %result_2 : f64
      %dtemp_temp_2 = arith.addf %dtemp_temp_1, %result_3 : f64
      %dtemp_temp_3 = arith.addf %dtemp_temp_2, %result_4 : f64
      %dtemp_temp_4 = arith.addf %dtemp_temp_3, %result_5 : f64
      %dtemp_next_3 = arith.addf %dtemp_temp_4, %result_6 : f64

      scf.yield %dtemp_next_3 : f64
    }
    return %dtemp_3 : f64
}
